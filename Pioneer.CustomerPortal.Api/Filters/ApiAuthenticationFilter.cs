            ...
            if (provider != null)
            {
                ...
                if (userId != null)
                {
                    ...
                    if (basicAuthenticationIdentity != null)
                        basicAuthenticationIdentity.UserId = userId.EmailAddress;
                    basicAuthenticationIdentity.UserType = userId.UserType;
                    basicAuthenticationIdentity.UserName = userId.EmailAddress;
                    return true;
                }
            }
            return false;
